  ...
  theme: {
    ...
    extend: {
      ...
      keyframes: {
        ...
        glow: { "0%": { boxShadow: "0 0 20px hsl(var(--primary) / 0.2)" }, "100%": { boxShadow: "0 0 40px hsl(var(--primary) / 0.4)" } },
      },
      animation: {
        "accordion-down": "accordion-down 0.2s ease-out", "accordion-up": "accordion-up 0.2s ease-out",
        "fade-in": "fade-in 0.5s ease-out", "fade-in-up": "fade-in-up 0.6s ease-out", float: "float 6s ease-in-out infinite", glow: "glow 2s ease-in-out infinite alternate",
      },
      backgroundImage: { "gradient-radial": "radial-gradient(var(--tw-gradient-stops))", "hero-gradient": "linear-gradient(180deg, hsl(222 47% 8%) 0%, hsl(222 47% 4%) 100%)" },
    },
  },
